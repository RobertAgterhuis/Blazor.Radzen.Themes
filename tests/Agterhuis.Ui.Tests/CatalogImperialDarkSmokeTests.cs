...
public sealed class CatalogImperialDarkSmokeTests
{
    [Fact]
    public void KeyCatalogPages_RenderUnderImperialDarkTheme()
    {
        ...
        Assert.Equal("imperial-dark", themeState.Theme);
