...
public sealed class CatalogAutotaalglasMonoDarkSmokeTests
{
    [Fact]
    public void KeyCatalogPages_RenderUnderAutotaalglasMonoDarkTheme()
    {
        ...
        {
            DefaultTheme = "autotaalglas-mono-dark",
        ...
        Assert.Equal("autotaalglas-mono-dark", themeState.Theme);
