...
public sealed class CatalogAutotaalglasContrastLightSmokeTests
{
    [Fact]
    public void KeyCatalogSlices_RenderUnderAutotaalglasContrastLightTheme()
    {
        ...
        {
            DefaultTheme = "autotaalglas-contrast-light",
        ...
        Assert.Equal("autotaalglas-contrast-light", themeState.Theme);
