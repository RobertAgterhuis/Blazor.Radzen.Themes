...
public sealed class CatalogMs365DarkSmokeTests
{
    [Fact]
    public void KeyCatalogPages_RenderUnderMs365DarkTheme()
    {
        ...
        Assert.Equal("ms365-dark", themeState.Theme);
