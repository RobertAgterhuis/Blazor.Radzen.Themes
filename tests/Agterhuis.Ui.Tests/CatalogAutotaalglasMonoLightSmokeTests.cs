...
public sealed class CatalogAutotaalglasMonoLightSmokeTests
{
    [Fact]
    public void KeyCatalogSlices_RenderUnderAutotaalglasMonoLightTheme()
    {
        ...
        {
            DefaultTheme = "autotaalglas-mono-light",
        ...
        Assert.Equal("autotaalglas-mono-light", themeState.Theme);
