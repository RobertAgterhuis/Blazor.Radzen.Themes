...
public sealed class CatalogAutotaalglasPortalDarkSmokeTests
{
    [Fact]
    public void KeyCatalogPages_RenderUnderAutotaalglasPortalDarkTheme()
    {
        ...
        {
            DefaultTheme = "autotaalglas-portal-dark",
        ...
        Assert.Equal("autotaalglas-portal-dark", themeState.Theme);
