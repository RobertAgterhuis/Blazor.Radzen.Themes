...
public sealed class CatalogAzureDarkSmokeTests
{
    [Fact]
    public void KeyCatalogPages_RenderUnderAzureDarkTheme()
    {
        ...
        Assert.Equal("azure-dark", themeState.Theme);
