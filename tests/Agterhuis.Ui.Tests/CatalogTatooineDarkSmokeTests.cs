...
public sealed class CatalogTatooineDarkSmokeTests
{
    [Fact]
    public void KeyCatalogPages_RenderUnderTatooineDarkTheme()
    {
        ...
        Assert.Equal("tatooine-dark", themeState.Theme);
