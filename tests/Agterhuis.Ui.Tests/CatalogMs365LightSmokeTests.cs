...
public sealed class CatalogMs365LightSmokeTests
{
    [Fact]
    public void KeyCatalogPages_RenderUnderMs365LightTheme()
    {
        ...
        Assert.Equal("ms365-light", themeState.Theme);
