...
public sealed class CatalogAutotaalglasContrastDarkSmokeTests
{
    [Fact]
    public void KeyCatalogPages_RenderUnderAutotaalglasContrastDarkTheme()
    {
        ...
        {
            DefaultTheme = "autotaalglas-contrast-dark",
        ...
        Assert.Equal("autotaalglas-contrast-dark", themeState.Theme);
