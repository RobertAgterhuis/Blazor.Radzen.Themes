...
public partial class AgtSecondaryButton
{
    [Parameter]
    ...
    private string CombinedClass => string.IsNullOrWhiteSpace(CssClass) ? "agt-secondary-button" : $"agt-secondary-button {CssClass}";
