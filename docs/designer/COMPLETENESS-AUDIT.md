...
| Code-tab (read-only Razor preview) met selectie-highlight | ⚠️ Gedeeltelijk | De read-only codeweergave is nu ingebed in de designerpagina, maar selectie-highlighting ontbreekt nog. |
